    ...
    <section id="blog-video">
      ...
      <article class="row">
        ...
        <article class="col-md-4">
          <h2>Summer Internship Vlog</h2>
          <p>Check out my video about my summer internship with the UVM Wellness Environment. During my time there I advised on the UVM WE App used campus wide by thousands of students. Collaborated with other students to create an app for Dr. James Hudziak, creator and director of the Wellness Environment, for automatic attendance tracking.</p>
          <a class="btn" href="blog.php">Go Read More Blogs</a>
        </article>
      </article>
      </section>
      -->
