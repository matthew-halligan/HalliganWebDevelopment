...
{	
	if(empty($_POST["username"]) && empty($_POST["password"]))  
      ...
      {  
		$sql = "SELECT * FROM tblusers WHERE username = '".mysqli_real_escape_string($db, $_POST['login'])."' AND password = '".md5(mysqli_real_escape_string($db, $_POST['password']))."'";
		...
		if($records->num_rows > 0){
	        ...
	        $_SESSION["admin_username"] = $_POST['login'];
	       	header("location: dashboard.php");
			exit;
		}else{
...
<div class="wrapper">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="../images/logo.png" id="icon" alt="User Icon" width="100" />
    </div>
