...
<div class="sub-page-title">
  <div class="container">
    <div class="page-title">
      <h2>Elegance Triple Action Gel</h2>
    </div>
  </div>
</div>
<div class="content">
        ...
        <div class="product-slider">
         <div class="swiper-container gallery-top">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img src="images/product/elegance-triple-action-gel/1.png"></div>
          ...
          <span class="product-price">$15</span>
           <ul class="list">
            ...
            <div class="mt-4">
                ...
                <input type="hidden" name="item_name" value="Elegance Triple Action Gel">
